...
'Usado quando escreves palavras na barra de endereço.':'Used when you type words in the address bar.','Alterna entre a interface escura e clara neste perfil.':'Switch between dark and light interface in this profile.','Remove cookies, cache e armazenamento apenas deste perfil.':'Remove cookies, cache and storage only for this profile.','Descarrega abas inativas da memória e recarrega-as quando voltares.':'Unload inactive tabs from memory and reload them when you return.','Nunca':'Never','5 minutos':'5 minutes','10 minutos':'10 minutes','15 minutos':'15 minutes','30 minutos':'30 minutes','1 hora':'1 hour','Separa trabalho, pessoal e outras sessões do browser.':'Separate work, personal and other browser sessions.','Dados, abas e logins separados':'Separate data, tabs and logins'
});Object.assign(map,{
...
function translateString(src){
 ...
 s=s.replace(/^A transferir…$/,'Downloading…').replace(/^Concluído$/,'Completed').replace(/^Falhou$/,'Failed');
 return lead+s+tail;
}
